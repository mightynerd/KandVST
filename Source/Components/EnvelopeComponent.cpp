...
EnvelopeComponent::EnvelopeComponent(int ID, GLOBAL* global, String prefix) :
	IVSTParameters(ID),
	...
	__prefix(prefix)
{
	...
	addAndMakeVisible(attackTime = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_ATTACK_TIME"), Global));
	...
	addAndMakeVisible(holdTime = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_HOLD_TIME"), Global));
	...
	addAndMakeVisible(decayTime = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_DECAY_TIME"), Global));
	...
	addAndMakeVisible(sustainTime = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_SUSTAIN_TIME"), Global));
	...
	addAndMakeVisible(releaseTime = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_RELEASE_TIME"), Global));
	...
	addAndMakeVisible(attackCurve = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_ATTACK_CURVE"), Global));
	...
	addAndMakeVisible(decayCurve = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_DECAY_CURVE"), Global));
	...
	addAndMakeVisible(sustainCurve = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_SUSTAIN_CURVE"), Global));
	...
	addAndMakeVisible(releaseCurve = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_RELEASE_CURVE"), Global));
	...
	addAndMakeVisible(attackLevel = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_ATTACK_LEVEL"), Global));
	...
	addAndMakeVisible(decayLevel = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_DECAY_LEVEL"), Global));
	...
	addAndMakeVisible(sustainLevel = new ParameterSlider(*Global->paramHandler->Get<AudioParameterFloat>(__ID, prefix + "ENV_SUSTAIN_LEVEL"), Global));
	...
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_DECAY_TIME");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_SUSTAIN_TIME");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_RELEASE_TIME");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_ATTACK_CURVE");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_DECAY_CURVE");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_SUSTAIN_CURVE");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_RELEASE_CURVE");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_ATTACK_LEVEL");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_DECAY_LEVEL");
	Global->paramHandler->addParamaterListener(this, ID, prefix.toStdString() + "ENV_SUSTAIN_LEVEL");
