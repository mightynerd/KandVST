...
#ifndef FILTER_BUTTERWORTH_ENV_H
#define FILTER_BUTTERWORTH_ENV_H
#include "IEffect.h"
...
public:
	FilterButterworthEnv(int ID, double sampleRate, String parameterId,GLOBAL*global);
	~FilterButterworthEnv();
...
#endif //FILTER_BUTTERWORTH_ENV_H
